...
class NodeImagesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.nodeImages.index', compact('nodeImages'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.nodeImages.create');
    }
    ...
    public function store(StoreNodeImageRequest $request)
    {
        ...
        return redirect()->route('frontend.node-images.index');
    }
    ...
    public function edit(NodeImage $nodeImage)
    {
        ...
        return view('frontend.nodeImages.edit', compact('nodeImage'));
    }
    ...
    public function show(NodeImage $nodeImage)
    {
        ...
        return view('frontend.nodeImages.show', compact('nodeImage'));
    }
