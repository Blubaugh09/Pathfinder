    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.node-types.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="text_color" id="text_color" value="{{ old('text_color', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="font_size" id="font_size" value="{{ old('font_size', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="icon_url" id="icon_url" value="{{ old('icon_url', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event" id="event" value="{{ old('event', '') }}">
                            @if($errors->has('event'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('event') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="node" id="node" value="{{ old('node', '') }}">
                            @if($errors->has('node'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('node') }}
                                </div>
