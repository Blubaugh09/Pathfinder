                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sessions.update", [$session->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="start_time" id="start_time" value="{{ old('start_time', $session->start_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="end_time" id="end_time" value="{{ old('end_time', $session->end_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="active" id="active" value="{{ old('active', $session->active) }}" step="1">
