    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sessions.update", [$session->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text" name="start_time" id="start_time" value="{{ old('start_time', $session->start_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('end_time') ? 'is-invalid' : '' }}" type="text" name="end_time" id="end_time" value="{{ old('end_time', $session->end_time) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('active') ? 'is-invalid' : '' }}" type="number" name="active" id="active" value="{{ old('active', $session->active) }}" step="1">
