...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.node-types.update", [$nodeType->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="shape">{{ trans('cruds.nodeType.fields.shape') }}</label>
                <input class="form-control {{ $errors->has('shape') ? 'is-invalid' : '' }}" type="text" name="shape" id="shape" value="{{ old('shape', $nodeType->shape) }}">
                @if($errors->has('shape'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('color') ? 'is-invalid' : '' }}" type="text" name="color" id="color" value="{{ old('color', $nodeType->color) }}">
                @if($errors->has('color'))
                    <div class="invalid-feedback">
                        {{ $errors->first('color') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type" id="type" value="{{ old('type', $nodeType->type) }}">
                @if($errors->has('type'))
                    <div class="invalid-feedback">
                        {{ $errors->first('type') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('text_color') ? 'is-invalid' : '' }}" type="text" name="text_color" id="text_color" value="{{ old('text_color', $nodeType->text_color) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('font_size') ? 'is-invalid' : '' }}" type="text" name="font_size" id="font_size" value="{{ old('font_size', $nodeType->font_size) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visibility') ? 'is-invalid' : '' }}" type="text" name="visibility" id="visibility" value="{{ old('visibility', $nodeType->visibility) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight') ? 'is-invalid' : '' }}" type="text" name="weight" id="weight" value="{{ old('weight', $nodeType->weight) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icon_url') ? 'is-invalid' : '' }}" type="text" name="icon_url" id="icon_url" value="{{ old('icon_url', $nodeType->icon_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('event') ? 'is-invalid' : '' }}" type="text" name="event" id="event" value="{{ old('event', $nodeType->event) }}">
                @if($errors->has('event'))
                    <div class="invalid-feedback">
                        {{ $errors->first('event') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('node') ? 'is-invalid' : '' }}" type="text" name="node" id="node" value="{{ old('node', $nodeType->node) }}">
                @if($errors->has('node'))
                    <div class="invalid-feedback">
                        {{ $errors->first('node') }}
                    </div>
