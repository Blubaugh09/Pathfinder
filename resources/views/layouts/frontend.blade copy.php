                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('user_interaction_access')
                                        <a class="dropdown-item" href="{{ route('frontend.user-interactions.index') }}">
                                            {{ trans('cruds.userInteraction.title') }}
                                        </a>
                                    @endcan
                                    @can('bookmark_access')
                                        <a class="dropdown-item" href="{{ route('frontend.bookmarks.index') }}">
                                    ...
                                    @endcan
                                    @can('note_access')
                                        <a class="dropdown-item" href="{{ route('frontend.notes.index') }}">
                                            {{ trans('cruds.note.title') }}
                                        </a>
                                    @endcan
                                    @can('node_image_access')
                                        <a class="dropdown-item" href="{{ route('frontend.node-images.index') }}">
                                            {{ trans('cruds.nodeImage.title') }}
                                        </a>
                                    @endcan
                                    @can('node_type_access')
                                        <a class="dropdown-item" href="{{ route('frontend.node-types.index') }}">
